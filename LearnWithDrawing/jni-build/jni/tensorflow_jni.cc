...
extern "C" {
JNIEXPORT void JNICALL Java_com_example_alpay_learnwithdrawing_DigitDetector_init(JNIEnv *env, jclass c)
{
...
extern "C" {
JNIEXPORT void JNICALL Java_com_example_alpay_learnwithdrawing_DigitDetector_detectDigit(JNIEnv *env, jclass c)
{
	TENSORFLOW_METHOD(detectDigit)
	(JNIEnv * env, jobject thiz, jintArray raw_pixels)
	{
